...
const Products = () => {
    ...
    //     try {
    //      const {data} = await axios.get(`/api/v1/product/product-photo/${category._id}`)
    //      if(data){
    //         setImage(image.product.photo.data)
  ...
  return (
    ...
    {/* <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg" src={`api/v1/product/product-photo/${prod._id}`} alt=""/> */}
    ...
    <div class="flex flex-col justify-between p-4 leading-normal">
      ...
      <button className="bg-blue-400 text-white m-1 p-1  rounded"> Details</button>
      <button className="bg-emerald-400 text-white p-1 m-1 rounded-lg">+</button>
      </div> */}
    </div>
